...
Amber::Server.configure do |settings|
  ...
  #
  settings.name = "Guest Control web application."
  #
  #
  ...
  #
  # settings.secret_key_base= jZFmMcQdazDm9kPVNKOceOFo3wuuVwoaZbsXln3PSPk
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("guest_control.log", "w"))
  #
  #
end
